...
DEFAULT_FROM_EMAIL = config("DEFAULT_FROM_EMAIL", default="eDoc <noreply@gosdoc.gov.kz>")
...
SPECTACULAR_SETTINGS = {
    "TITLE": "eDOC API",
    "DESCRIPTION": "Облачная платформа документооборота",
    "VERSION": "1.0.0",
...
MEILISEARCH_KEY = config("MEILISEARCH_KEY", default="gosdoc-meili-key-2026")
